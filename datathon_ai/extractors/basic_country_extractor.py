    ...
    def extract(self, text: str) -> List[QuestionResponse]:
        ...
        for question_id in self.question_ids:
            ...
            if question_id in range(5,8):
                if question_id == 5:
                    answer_dict[5] = question(question_data, text)
                ...
                if question_id == 9:
                    answer_dict[9] = question(question_data, text)
                ...
                if question_id == 11:
                    answer_dict[11] = question(question_data, text)
                ...
                responses.append(question(question_data, text))
        return responses
